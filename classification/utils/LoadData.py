...
def train_data_loader(args, test_path=False, segmentation=False):
    ...
    train_loader = DataLoader(img_train, batch_size=args.batch_size, shuffle=True, num_workers=args.num_workers,drop_last=False)
    val_loader = DataLoader(img_test, batch_size=args.batch_size, shuffle=False, num_workers=args.num_workers,drop_last=False)
...
class VOCDataset(Dataset):
    def __init__(self, datalist_file, root_dir, num_classes=27, transform=None, test=False):

...
#     #model = torch.load(CONFIG.MODEL.INIT_MODEL, map_location=torch.device('cpu'))
#
...
#     )
#     makedirs(save_dir)
#     save_path = os.path.join(save_dir, "scores_final.json")
...
#
#     save_path = os.path.join(save_dir, "scores_final_crf.json")
#     print("Score dst:", save_path)
#
#     # Process per sample
#     def process(i):
